image::https://raw.githubusercontent.com/step-security/maintained-actions-assets/main/assets/maintained-action-banner.png[StepSecurity Maintained Action, link="https://docs.stepsecurity.io/actions/stepsecurity-maintained-actions"]

= GitHub Changelog Generator

A changelog generator for GitHub Issues, available as a https://github.com/step-security/github-changelog-generator/releases[release jar] or for use as a GitHub Action.
...
To generate a markdown changelog using a https://github.com/step-security/github-changelog-generator/releases[release jar], follow these steps:

- Download a https://github.com/step-security/github-changelog-generator/releases[release jar].
...
steps:
  - name: Generate Changelog
    uses: step-security/github-changelog-generator@v1
    with:
      milestone: '1.0.0'
----
